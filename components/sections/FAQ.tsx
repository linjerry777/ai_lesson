...
const faqs = [
  ...
  {
    q: '課程總共多長？學習節奏怎麼安排？',
    a: '7 章純文字 + 截圖實戰手冊，共 40+ 個 step-by-step 操作步驟、9 個可直接複製貼到 Claude Code 的指令範例。實作時間約 4-8 小時（看你打字速度），可以按自己節奏學。購買後永久存取，沒有時間壓力。我們特意做成文字版而不是影片——你能搜尋、能複製、能跟著貼，比看影片快 3 倍。',
  },
  {
