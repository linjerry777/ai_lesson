...
Preserve Claude Code course content unless Jerry explicitly asks to reposition the product. Codex / Image2 / Remotion has its own separate course product, so do not merge that workflow back into the Claude Code course unless asked.

Current course positioning:
- Text-first Claude Code course at NT$990.
