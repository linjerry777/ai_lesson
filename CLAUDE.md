...
This project is currently a text-first paid course platform. Do not assume it should become a video product just because Remotion and Image2 are now available elsewhere in the workspace.

Preserve Claude Code course content unless Jerry explicitly asks to reposition the product. New Codex / Image2 / Remotion knowledge should be added as optional modules, appendices, or future product notes first.
